...
- Legacy Shadows - Patches the shadows to cast to the right instead of the left, matching 2012-2015 behaviour. Can be toggled on the go.
- Legacy World Select - Restores old world select screen button sizes and optionally removes the "..." world name truncation. Can be toggled on the go.
